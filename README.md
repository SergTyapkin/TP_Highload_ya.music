...
Тип сервера                       | Кол-во | CPU (ядра) | RAM (Gb) | SSD (Gb) |
 ---------------------------------| -------| -----------| ---------| ---------| 
Nginx-балансировщик               | 1      | 2          | 8        | 64
Микросервис                       | 3      | 12         | 16       | 12
Redis (сессии)                    | 1      | 4          | 8        | 16
PostgreSQL (пользователи)         | 1      | 4          | 8        | 16
MongoDB (остальные таблицы)       | 1      | 16         | 32       | 768
MongoDB (треки, картинки)         | 1      | 16         | 32       | 700K
Всего                             | 8      | 54         | 104      | 364 + 700K в RAID 5
