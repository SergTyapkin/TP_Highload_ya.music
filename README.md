...
В каждой диски будут объединены в RAID 5 массив с двойной записью контрольных сумм и распределением фрагментов данных по всем дискам по очереди, ведь с них необходимо быстрое чтение.
Если один из дисков выйдет из строя, у нас есть копии данных как в других дата-центрах, так что восстановить его
можно как копированием данных из другого дата-центра, так и из RAID массива
...
MongoDB (остальные таблицы)       | 1      | 16         | 32       | 256
